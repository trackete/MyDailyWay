...
public class MainActivity extends AppCompatActivity
    ...
    public static final String MY_PERMISSIONS_REQUEST_FINE_LOCAtION = "MY_PERMISSIONS_REQUEST_FINE_LOCAtION";
                        ...
                        ADbuilder.setMessage("this permission is important for the app to function properly.")
                            ...
                            public void onClick(DialogInterface dialog, int id) {
                                ActivityCompat.requestPermissions(MainActivity
                                        .this, new String[](Manifest.permission.ACCESS_FINE_LOCATION), MY_PERMISSIONS_REQUEST_FINE_LOCAtION);
                            }
                        });
                        ADbuilder.create();
                        ADbuilder.show();
